...
MySQL - 10.4.21-MariaDB : Database - db_ztp_1720003
*********************************************************************
*/
...
insert  into `firewallfilter`(`chain`,`layer7protokol`,`action`,`comment`,`no`,`idfilter`) values 
('forward','0','drop','0',49,'*26'),
('forward','2','drop','2',51,'*3E');
...
insert  into `layer7protokol`(`name`,`regexp`,`id`) values 
('0','youtube.com','*1'),
('2','blibi.com','*3');
...
insert  into `tb_remotelogin`(`no`,`ip`,`username`,`password`) values 
(4,'192.168.88.1','admin','');
